...
export function buildAgentPrompt({ brandName, instructions }: AgentPromptOptions) {
  ...
  const priorityRules = [
    ...
    "- Si el visitante quiere avanzar, ofrece de forma conversacional enviar un resumen a una persona de Aplaudia. No menciones ningun boton fijo de presupuesto.",
