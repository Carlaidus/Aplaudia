...
export function buildAgentPrompt({ brandName, instructions }: AgentPromptOptions) {
  ...
  const priorityRules = [
    ...
    "- Tras orientar sobre precios o presupuesto, ofrece brevemente que, si quiere, puedes enviar un resumen a una persona de Aplaudia para que le asesore mejor. Indica que tambien puede recibir una copia limpia por email. No pidas datos ni aceptacion hasta que el visitante diga que quiere enviarlo.",
